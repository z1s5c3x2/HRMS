...
public interface ApprovalEntityRepository extends JpaRepository<ApprovalEntity,Integer> {
    ...
    @Query( value = "SELECT aprv.* FROM aprv JOIN aplog ON aprv.aprv_no = aplog.aprv_no JOIN emp ON aprv.emp_no = emp.emp_no " +
            ...
            , nativeQuery = true )
    Page< ApprovalEntity > approvalViewSearch( String key, String keyword, int apState, String strDate, String endDate, String empNo, Pageable pageable );
    ...
    @Query( value = "SELECT aprv.* FROM aprv JOIN aplog ON aprv.aprv_no = aplog.aprv_no JOIN emp ON aprv.emp_no = emp.emp_no " +
            ...
            , nativeQuery = true )
    Page< ApprovalEntity > reconsiderViewSearch( String key, String keyword, int apState, String strDate, String endDate, String empNo, Pageable pageable );
